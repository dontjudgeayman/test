...
if DeleteMob.Aimbot.WallCheck then
    canSeeTarget = isVisible(v.Character[DeleteMob.Aimbot.AimPart].Position, v.Character.Head.Parent)
end

if on_screen and new_magnitude < AimFov and canSeeTarget then
